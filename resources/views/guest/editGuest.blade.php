      ...
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form action="{{url('management_guest/'.$guest->guest_id)}}" method="POST">
               @method('patch')
              @csrf
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="name" class="form-control" placeholder="Enter Guest Name" value="{{$guest->guest_name}}">
                </div>
                <div class="form-group">
